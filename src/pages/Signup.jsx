...
//     email: "",
//     password: "",
//     confirmPassword: ""  // Fixed: not confConfirmPassword
//   });
...
//               <button className="flex items-center justify-center h-10 w-10 rounded-full bg-gray-100 hover:bg-gray-200">
...
import { jwtDecode } from "jwt-decode";
import axios from "axios";
import { signupUser } from "../api/auth";   // ✅ FIX: Import API
