...
//   // Toggle wishlist (add/remove) - UPDATED with redirect
//   const toggleWishlist = async (plotId, e) => {
//     e.stopPropagation();
//     const token = localStorage.getItem('token');
//     if (!token) {
...
//   // Handle contact agent with redirect
//   const handleContactAgent = (plot) => {
//     const token = localStorage.getItem('token');
//     if (!token) {
//       toast.error('Please login to contact the property agent');
...
//     // You can add API call here to contact agent
//   };
...
//                     <button
//                       onClick={(e) => toggleWishlist(plot._id, e)}
//                       className="absolute top-3 left-3 z-20 p-1 px-2 rounded-full bg-white bg-opacity-80 hover:bg-opacity-100 transition-all"
//                       title={wishlist.includes(plot._id) ? "Remove from wishlist" : "Add to wishlist"}
//                     >
//                       {wishlist.includes(plot._id) ? (
...
//               </button>
//               <button
//                 onClick={() => handleContactAgent(selectedPlot)}
//                 className="flex-1 px-6 py-2 bg-[#2b54a2] text-white rounded-lg hover:bg-[#1e3f78] transition-colors font-medium"
//               >
//                 Contact Agent
//               </button>
//             </div>
