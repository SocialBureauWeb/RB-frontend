...
//       if (data.success) {
//         // Automatically add uploaded video to the videos array
//         setFormData(prev => ({
//           ...prev,
//           videos: [...prev.videos, { 
//             url: data.data.url, 
...
//   //         postedBy: '673b1234567890abcdef1234' // Replace with actual user ID from auth
//   //       })
//   //     });
...
//                  focus:outline-none focus:ring-2 focus:ring-[#2b54a2]"
//     />
...
//             type="button"
//             onClick={addImage}
//             className="inline-flex items-center px-4 py-2 bg-[#2b54a2] text-white rounded-md hover:bg-[#2b54a2] focus:outline-none focus:ring-2 focus:ring-[#2b54a2]"
//           >
//             Add Image
//           </button>
//         </div>
...
//               type="button"
//               onClick={addVideo}
//               className="w-full inline-flex items-center justify-center px-4 py-2 bg-[#2b54a2] text-white rounded-md hover:bg-[#2b54a2] focus:outline-none focus:ring-2 focus:ring-[#2b54a2]"
//             >
//               Add Video
//             </button>
//           </div>
...
//             loading ? 'bg-green-200 cursor-not-allowed' : 'bg-[#2b54a2] hover:bg-green-700'
//           }`}
//         >
